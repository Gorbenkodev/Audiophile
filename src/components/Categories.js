  ...
  return(
    <div className="categories container-md">
            <div className="categories-block">
              ...
              <a className="categories-block_link" href="/headphones">shop <i class="arrow right"></i></a>           
            </div>
            <div className="categories-block">
              ...
              <a className="categories-block_link" href="/speakers">shop <i class="arrow right"></i></a>   
            </div>
            <div className="categories-block">
              ...
              <a className="categories-block_link" href="/earphones">shop <i class="arrow"></i></a>           
            </div>
          </div>
  )
}