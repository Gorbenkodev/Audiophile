    ...
    <div className="footer">
      ...
      <div className="footer-head">
        ...
        <ul className="footer-head-menu">
          ...
          <a className="footer-head-menu_item" href="/headphones"><li>headphone</li></a>
          <a className="footer-head-menu_item" href="/speakers"><li>speakers</li></a>
          <a className="footer-head-menu_item" href="/earphones"><li>earphones</li></a>
        </ul>
      </div>
